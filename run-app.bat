...
echo ^<div class="qr" id="qr"^>^<img src="https://api.qrserver.com/v1/create-qr-code/?size=420x420^&amp;margin=8^&amp;data=%LAN_URL%" alt="QR" onerror="this.style.display='none';renderJsQr^(^);" /^>^</div^>
